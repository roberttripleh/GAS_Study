...
private:
	...
	static void ShouldEnableButtons(
		...
		int32 SpellPoints, bool& bShouldEnableSpellPointsButton,
		bool& bShouldEnableEquipButton);

	FSelectedAbility SelectedAbility = {FPsychGameplayTags::Get().Abilities_None, FPsychGameplayTags::Get().Abilities_Status_Locked};
